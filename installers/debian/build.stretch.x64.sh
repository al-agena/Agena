...
cp -p "$AGENAHOME/../fltk-1.4.5/editor/agenaedit" "$AGENATARGET_BIN/"
...
cp -p "$AGENAHOME/ports/sragena-104/README.srglue" "$AGENA_INSTALL_DIR/"
...
cd "$MAINTARGETDIR"
dpkg-deb --root-owner-group --build agena "agena-$AGENAVER-linux.amd64.deb"
