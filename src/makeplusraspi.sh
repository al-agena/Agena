#!/bin/sh
# compile and install skript for the plus package for Raspbian Stretch
# execute this batch file in the .../agena/src folder by typing:
# sh makeplusraspi.sh

export OPTIONS="-DLUA_USE_LINUX -DDEBIAN -Wall -Wno-unused-function -O2 -g -shared -fgnu89-inline -fPIC -I../src -L../src"
...
for i in abci.o ads.o astro.o charbuf.o com.o cordic.o curses.o \
    ...
    sqlite.o sqlite3.o sunriset.o testlib.o zx.o strhash.o strmap.o \
    intmap.o
do
  if [ -f "$i" ]; then
    rm "$i"
...
#gcc $OPTIONS -c network.c -o network.o
#gcc $OPTIONS -shared -fPIC -o net.so net.c network.o
