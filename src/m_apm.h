 ...
 *      Initial revision
 *
 *      $Id: mapm.h,v 1.42 2007/12/03 02:28:25 mike Exp $
 */
...
/*
 *	convenient predefined constants
 */
...
public:
	...
	/* Basic operators: */
	MAPM &operator=(const MAPM &m) /* Assignment operator */
		{copyFrom((M_APM)m.cval());return *this;}
	MAPM &operator=(const char *s) /* Assignment operator */
		{m_apm_set_string(val(),(char *)s);return *this;}
	MAPM &operator=(double d) /* Assignment operator */
		{m_apm_set_double(val(),d);return *this;}
	MAPM &operator=(int l) /* Assignment operator */
		{m_apm_set_long(val(),l);return *this;}
	MAPM &operator=(long l) /* Assignment operator */
		{m_apm_set_long(val(),l);return *this;}
