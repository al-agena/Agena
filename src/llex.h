...
enum RESERVED {
  ...
  TK_OD, TK_ODD, TK_OF, TK_ONSUCCESS, TK_OR, TK_OVER, TK_POP, TK_POST, TK_PRE, TK_PROC, TK_PROCNAME, TK_PUSHD, TK_QMDEV, TK_QSUMUP,
  ...
  TK_EXCLMARK, TK_CARTESIAN, TK_DD, TK_OOP, TK_PP, TK_MM, TK_PEPS, TK_MEPS, TK_DATA, TK_ATAD, TK_SEQDATA, TK_SEQDATAEND, TK_ABSDIFF, TK_ACOMPARE,
