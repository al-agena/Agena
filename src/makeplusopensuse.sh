...
export OPTIONS="-O2 -g -Wno-attributes -fgnu89-inline -DLUA_USE_LINUX -DOPENSUSE -shared -I../src -L../src ../src/libagena.a"
export EXPORTTO="../lib"
...
gcc $OPTIONS -fpic -o com.so com.o luasys.o charbuf.o
strip com.so
...
gcc $OPTIONS -o net.so net.c network.h
strip net.so
