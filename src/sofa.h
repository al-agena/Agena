...
extern int    iauJd2cal (double dj1, double dj2, int *iy, int *im, int *id, double *fd);
...
extern double iauJuliandate (int yy, int mm, int dd, int h, int m, double s);
extern double iauJdfd (double dj1, double dj2);

#define JD_J2000_EPOCH 2451545.0
