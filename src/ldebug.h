...
LUAI_FUNC void luaG_typeerrorx (lua_State *L, const TValue *o, const char *what, const char *opname);
LUAI_FUNC void agnG_indexerror (lua_State *L, const TValue *o, const TValue *key);
