...
/* Radians to degrees */
#define DR2D (57.29577951308232087679815)  /* 2.10.3 */
...
#define DAU (149597870.7e3)  /* 2.10.3 */

/* Speed of light (m/s) */
#define CMPS 299792458.0  /* 2.10.3 */

/* Light time for 1 au (s) */
#define AULT (DAU/CMPS)  /* 2.10.3 */

/* Speed of light (au per day) */
#define DC (DAYSEC/AULT)  /* 2.10.3 */
...
#define SRS 1.97412574336e-8  /* 2.10.3 */

/* dint(A) - truncate to nearest whole number towards zero (double) */
#define dint(A) ((A) < 0.0 ? sun_ceil(A) : sun_floor(A))

/* dnint(A) - round to nearest whole number (double) */
#define dnint(A) ((A) < 0.0 ? sun_ceil((A)-0.5) : sun_floor((A)+0.5))

/* dsign(A,B) - magnitude of A with sign of B (double) */
#define dcopysign(A,B) ((B) < 0.0 ? -fabs(A) : fabs(A))

/* max(A,B) - larger (most +ve) of two numbers (generic) */
#define gmax(A,B) (((A) > (B)) ? (A) : (B))  /* 2.10.3 */

/* min(A,B) - smaller (least +ve) of two numbers (generic) */
#define gmin(A,B) (((A) < (B)) ? (A) : (B))  /* 2.10.3 */
